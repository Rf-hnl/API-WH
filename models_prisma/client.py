...
SCHEMA_PATH = Path('/Users/raulfernandez/Documents/BOT DE WH/LEAds/IA MARIA ACTUAL /TWILIO-WH-MAR-IA/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/raulfernandez/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    whatsappmessage: 'actions.WhatsappMessageActions[models.WhatsappMessage]'
    ...
    def __init__(
        ...
        *,
        ...
        self.whatsappmessage = actions.WhatsappMessageActions[models.WhatsappMessage](self, models.WhatsappMessage)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/raulfernandez/Documents/BOT DE WH/LEAds/IA MARIA ACTUAL /TWILIO-WH-MAR-IA/prisma/schema.prisma',
        }
...
class Batch:
    ...
    whatsappmessage: 'WhatsappMessageBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.whatsappmessage = WhatsappMessageBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class WhatsappMessageBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
